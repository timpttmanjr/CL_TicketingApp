...
Public Class AddActivityWebUserControlSmall
    Inherits System.Web.UI.UserControl

    Public Property ActivityItem As String
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack() Then
            ...
            Me.HeaderTableRow.Visible = "false"' (Me.ActivityItem = "a1")
            Select Case Me.ActivityItem
                Case "a1"
                    Me.ActivityTypeDropDownList.Items.FindByValue("Pickup").Selected = True
                Case "a2"
                    Me.ActivityTypeDropDownList.Items.FindByValue("Delivery").Selected = True
                Case Else
                    Me.ActivityTypeDropDownList.Items(0).Selected = True
